...
function loadSound(path, callback, onerror, whileLoading) {
  ...
  var self = this;
  var s = new soundfileSoundFile(path, function () {
 ...
 var soundfile = (soundfileSoundFile);
...
function () {
  ...
  fft_createClass(FFT, [{
     ...
     *    let rectangleWidth = (log(i+1)-log(i))*(width/log(spectrum.length));
     *    rect(x, height, rectangleWidth, -h )
     *  }
     *  let nyquist = 22050;
     *
     *  // get the centroid
...
function () {
 ...
 var soundLoop = (soundLoopSoundLoop);
...
var soundRecorderSoundRecorder =
function () {
 ...
 var soundRecorder = (soundRecorderSoundRecorder);
